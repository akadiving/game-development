...
def get_translated_message(mode, message, key):
    ...
    for symbol in message:
        ...
        if symbol_index == -1: # Symbol not found in SYMBOLS.
            ...
            if symbol_index >= len(SYMBOLS):    # This if statement allows symbol_index to go past the last index of SYMBOLS when the sum is more than len(SYMBOLS), we’ll need to wrap around to the beginning of the list at 0.
